  ...
  <>
    <Divider speed={0.2} offset={offset}>
      ...
      <UpDownWide>
        ...
        <SVG icon="triangle" width={16} stroke={colors['grey-dark']} left="30%" top="65%" />
        <SVG icon="circle" width={6} fill={colors['grey-dark']} left="75%" top="10%" />
        <SVG icon="upDown" hiddenMobile width={8} fill={colors['grey-dark']} left="45%" top="10%" />
      </UpDownWide>
      ...
      {/* <SVG icon="box" hiddenMobile width={24} fill={colors.purple} left="5%" top="90%" /> */}
